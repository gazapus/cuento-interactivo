const lago_gazaposo = {
    ...
    content: [
        {
            text: 'Los conejitos emprendieron el camino hacía el Lago Gazaposo. Correteaban y jugaban en el camino, comían algún que otro pastito y seguían su viaje. El Lago Gazaposo se encontraba colina abajo, por lo que cuando se encontraban ante un pasaje con mucho declive se tomaban la mano de las patas y bajaban juntos corriendo. En la primera vez el Príncipe se tropezó pero luego ya aprendío de la Princesa y lo hizo bien.',
