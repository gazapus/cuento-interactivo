const bosque_exploracion_incorrecta = {
    name: 'bosque_exploracion_incorrecta',
    content: [
        {
            text: 'Se han equivocado así que no puedo ayudarlos. Así que mis más sinceros deseos de que encuentren lo buscado, con su permiso me retiro a mi casa a tomar helado - dijo retirandose hacía su casa pero antes Gazapo le interrumpió.',
            img: './src/images/bs4.jpg'
        },
        {
            text: ' - Somos el Príncipe y la Príncesa, soberanos de estas tierras así le exigimos que nos ayuda con nuestra grandiosa empresa, así que buen buho diganos donde encontrar el arbol de paltas doradas.',
            img: './src/images/bs3.jpg'
        }  ,
        {
            text: '- No puedo decirles exactamente donde se encuntra dicho arbol su ubicación va cambiando según los nutrientes de esas tierras lo que sí puedo decirles es cómo deben buscarlo: sigan el resplandor del brillo que no es del sol, guiense por la luz que ilumina hasta los lugares más oscuros y nunca pierdan el rastro de lo que los ha traido hasta aquí, si siguen estos consejos encontrarán el fruto del amor- concluyó el sabio entrandose a su casa y cerrando la puerta.',
            img: './src/images/bs4.jpg'
        },
        {
